var test = {
	"module": {
		"name": "net",
		"path": "d/project/FPGA/FPGA_Design/TCL_project/Test/sim_test/user/src/Verilog/template.v",
		"text": `module up3down5(clock, data_in, up, down, carry_out, borrow_out, count_out, parity_out);
