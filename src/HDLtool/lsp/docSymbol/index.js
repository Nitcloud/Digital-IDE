...
const { positionAfterEqual } = require('../util');
const { vlogParser, HDLParam, SymbolResult } = require('../../../HDLparser');


class VlogDocSymbolProvider {
    /**
     * @descriptionCn provide outline
     ...
     * @returns {Array<vscode.DocumentSymbol>}
     */
    makeSymbolInfos(document, symbols) {
        let docSymbols = [];
