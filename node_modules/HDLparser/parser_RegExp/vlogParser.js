    ...
    while (1) {
        ...
        if (type != "simple") {
            ...
            if (match.groups.ports) {
                ...
                structure.ports = get_ports(match.groups.ports, document, item.name, item.startIndex + offset, HDLSymbol);
            }
            if (match.groups.params) {
                offset  = match[0].indexOf(match.groups.params);
                structure.parameter = get_parameter(match.groups.params, document, item.name, item.startIndex + offset, HDLSymbol);
            }
