...
class index {
    ...
    getFileParam(document, type, offset = 0, parent, HDLparam) {
        ...
        if (document.languageId == "systemverilog" || document.languageId == "verilog") {
            symbols = vlogParser.getFileParam(document, type, offset, parent, HDLparam, this.HDLSymbol);
        } else if (document.languageId == "vhdl") {
            symbols = vhdlParser.getFileParam(document, type, offset, parent, HDLparam, this.HDLSymbol);
        }
