...
class vlogCompletion {
    ...
    provideCompletionItems(document, position, token) {
        return new Promise((resolve, reject) => {
            ...
            let completionItemsIndex = this.positionToIndex(content, position);
            ...
            while (1) {
                ...
                let paramIndexStart = match.index + 
                                    this.getMatchLength(match[1]) + 
                                    this.getMatchLength(match[2]);
                let paramIndexEnd   = paramIndexStart + 
                                    this.getMatchLength(match[3]);
                let portIndexStart  = paramIndexEnd   + 
                                    this.getMatchLength(match[4]) + 
                                    this.getMatchLength(match[5]);
                let portIndexEnd    = portIndexStart  + 
                                    this.getMatchLength(match[6]);
    ...
    positionToIndex(content, position) {
        let index = 0;
        ...
        index = index + position.character;
        return index;
    }
}
