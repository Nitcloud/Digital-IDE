...
async function get_template() {
    ...
    // const TYPES_VHDL_INFO = ["cocotb", "VUnit testbench", "VHDL testbench", "Copy as component", "Copy as signal", "Copy as instance", "Copy as instance VHDL >=93"];
    const TYPES_VHDL_INFO = ["cocotb", "VUnit testbench"];
    const TYPES_VHDL = ["cocotb", "tb", "tb", "component", "component", "component", "component"];
    const SUBTYPES_VHDL = ["cocotb", "vunit", "normal", "component", "signals", "instance", "instance_vhdl_2008"];
    const TYPES_VERILOG_INFO = ["cocotb", "Verilator", "VUnit testbench", "Verilog testbench", "Copy as signal", "Copy as instance"];
    const TYPES_VERILOG = ["cocotb", "verilator", "tb", "tb", "component", "component"];
    const SUBTYPES_VERILOG = ["cocotb", "verilator", "vunit", "normal", "signals", "instance"];
    let type = "";
    let subtype = "";
    ...
    if (language_id === "vhdl") {
        let picker_value = await vscode.window.showQuickPick(TYPES_VHDL_INFO, { placeHolder: 'Select the template type.' });
        ...
        let picker_value = await vscode.window.showQuickPick(TYPES_VERILOG_INFO, { placeHolder: 'Select the template type.' });
...
class Verilog_editor {
    ...
    async generate(src, options) {
        ...
        if (options !== null) {
            vunit = options['type'] === TYPESTESTBENCH.VUNIT;
...
class Verilog_component extends Verilog_editor {
    async generate(src, options) {
        ...
        var component = "";
        if (options['type'] === TYPESCOMPONENTS.COMPONENT) {
            component = "";
        } else if (options['type'] === TYPESCOMPONENTS.INSTANCE) {
            component = this.set_instance2001('  ', structure['entity']['name'],
                structure['generics'], structure['ports'], false);
        } else if (options['type'] === TYPESCOMPONENTS.SIGNALS) {
...
class Vhdl_component extends Vhdl_editor {
    async generate(src, options) {
        ...
        } else if (options['type'] === TYPESCOMPONENTS.INSTANCE_VHDL2008) {
            component = this.set_Instance('  ', structure['entity']['name'],
