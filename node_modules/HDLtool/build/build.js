...
class fpgaRegister {
    ...
    getConfig() {
        this.xilinxInstallPath = this.setting.get('TOOL.xilinx.install.path');
        this.vivadoPath = "vivado";
        // if (this.xilinxInstallPath != "") {
        //     this.vivadoPath = this.xilinxInstallPath.replace("//","/").replace(/\\/g,"\/") + "/Vivado/";
        //     this.version = fs.readdirSync(this.vivadoPath);
        //     this.vivadoPath = this.vivadoPath + this.version[0] + "/bin/vivado.bat";
        //     // if (version.length == 1) {
        //     //     this.vivadoPath = this.vivadoPath + this.version[0] + "/bin/vivado";
        //     // }
        // }
    }
    Launch() {
