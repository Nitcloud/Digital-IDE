...
const state_machine_viewer   = require("./state_machine/state_machine_viewer");
const state_machine_designer = require("./state_machine/state_machine_designer");
...
function registerDebugServer(opeParam) {
...
function registerToolServer(opeParam, context) {
    let toolRegister = new debug.toolRegister(opeParam);
    ...
    context.subscriptions.push(vscode.commands.registerCommand('TOOL.state_machine.viewer', () => __awaiter(this, void 0, void 0, function* () {
    ...
    context.subscriptions.push(vscode.commands.registerCommand('TOOL.state_machine.designer', () => __awaiter(this, void 0, void 0, function* () {
