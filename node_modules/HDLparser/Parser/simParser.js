                ...
                if (element.moduleName == unitInstanceModule.instModule) {
                    if (fs.existsSync(unitInstanceModule.instModPath)) {
                        vscode.window.showWarningMessage(
                            `Multiple files of the ${element.moduleName} appear in the project\n` + 
                            `one is ${unitInstanceModule.instModPath}\n` +
                            `other one is ${element.modulePath}\n`
                        );
                    }
...
function getSrcTopElement(opeParam, TopElementList) {
...
function getTbTopElement(opeParam, TopElementList) {
