...
class Parser extends base_parser.base_parser {
    ...
    get_all(sourceCode, comment_symbol) {
        let structure;
    ...
    add_port(element, key, name, direction, type, ansi, items, comments, lines) {
        ...
        for (var i = 0; i < port_name.length; i++) {
            ...
            "default_value": "",
            "description": comment,
            "satrt_index": element.startIndex,
    ...
    get_signals(tree, lines, comments) {
        ...
        'net_type', 'packed_dimension', element);

        this.get_signal_array(inputs2, comments, items, lines, 'list_of_variable_decl_assignments',
        'data_type_or_implicit1', 0, element);
        return items;
    }

    get_signal_array(inputs, comments, items, lines, name_command, type_command, type_dim, element) {
        var item = {};
        for (var x = 0; x < inputs.length; ++x) {
        let comment = "";
        ...
        if (arr_signals !== 'undefined') {
            ...
            item = {
                ...
                "satrt_index": element.startIndex,
                "end_index": element.endIndex, 
                "start_line": element.startPosition.row
            };
