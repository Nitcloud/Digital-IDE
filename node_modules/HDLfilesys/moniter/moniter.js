...
function monitor (path, opeParam, indexer, outputChannel, callback) {
    ...
    watcher.onDidChange((uri) => {
        let currentfspath =  uri.fsPath.replace("//","/").replace(/\\/g,"\/");
        ...
        if (currentfspath.indexOf("synth_1/runme.log") != -1) {
            let log = showlog(synthPath);
            if (log != "") {
                outputChannel.show(true);
                outputChannel.appendLine(log);
            }
        } else if (currentfspath.indexOf("impl_1/runme.log") != -1) {
            let log = showlog(implPath);
            if (log != "") {
                outputChannel.show(true);
                outputChannel.appendLine(log);
            }
        } else if (currentfspath.indexOf("xsim/xvlog.log") != -1 || currentfspath.indexOf("xsim/elaborate.log") != -1) {
            ...
            HDLFilePrecess(currentfspath, indexer, opeParam, callback);
        }
    });
