...
class Linter {
    ...
    config_linter() {
        ...
        switch (this.vhdl.name) {
            case "ghdl":     this.vhdl_linter = new Ghdl;     break;
            case "vivado":   this.vhdl_linter = new Vivado;   break;
            case "modelsim": this.vhdl_linter = new Modelsim; break;
