...
var IcarusLinter = require("HDLlinter/Linter/IcarusLinter");
var VerilatorLinter = require("HDLlinter/Linter/VerilatorLinter");

var ModelsimLinter = require("HDLlinter/Linter/ModelsimLinter");

var XvlogLinter  = require("HDLlinter/Linter/XvlogLinter");
var XvhdlLinter  = require("HDLlinter/Linter/XvhdlLinter");
var XmixedLinter = require("HDLlinter/Linter/XmixedLinter");

function registerLinterServer() {
    var lintManager = new LintManager();
...
var LintManager = /** @class */ (function () {
    ...
    LintManager.prototype.configLinter = function () {
        ...
        if (this.linter == null || this.linter.name != linter_name) {
            switch (linter_name) {
                case "iverilog":
                    this.linter = new IcarusLinter["default"]();
                    break;
                case "xvlog":
                    this.linter = new XvlogLinter["default"]();
                    break;
                case "xvhdl":
                    this.linter = new XvhdlLinter["default"]();
                    break;
                case "xmixed":
                    this.linter = new XmixedLinter["default"]();
                    break;
                case "modelsim":
                    this.linter = new ModelsimLinter["default"]();
                    break;
                case "verilator":
                    this.linter = new VerilatorLinter["default"]();
                    break;
                default:
    ...
    LintManager.prototype.lint = function (doc) {
        ...
        if (this.linter != null && (lang === "verilog" || lang === "vhdl" || lang === "systemverilog"))
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(vscode.window.activeTextEditor === undefined || (lang !== "verilog" && lang !== "vhdl" && lang !== "systemverilog"))) return [3 /*break*/, 1];
                        vscode.window.showErrorMessage("HDL: No document opened");
                        return [3 /*break*/, 4];
                    case 1: return [4 /*yield*/, vscode.window.showQuickPick([
                            ...
                            { label: "xvlog",
                                description: "Vivado Logical verilog and systemverilog Simulator"
                            },
                            { label: "xvhdl",
                                description: "Vivado Logical VHDL Simulator"
                            },
                            { label: "xmixed",
                                description: "Vivado Logical verilog and systemverilog and VHDL Simulator"
                            },
                            { label: "modelsim",
                    ...
                    case 2:
                        ...
                        switch (linterStr.label) {
                            case "iverilog":
                                tempLinter = new IcarusLinter["default"]();
                                break;
                            case "xvlog":
                                tempLinter = new XvlogLinter["default"]();
                                break;
                            case "xvhdl":
                                tempLinter = new XvhdlLinter["default"]();
                                break;
                            case "xmixed":
                                tempLinter = new XmixedLinter["default"]();
                                break;
                            case "modelsim":
                                tempLinter = new ModelsimLinter["default"]();
                                break;
                            case "verilator":
                                tempLinter = new VerilatorLinter["default"]();
                                break;
                            default:
                                return [2 /*return*/];
                        }
