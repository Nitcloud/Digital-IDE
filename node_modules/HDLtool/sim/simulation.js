...
class iverilogSimulate {
    ...
    getInstmoduleFilePathList(indexer, module, instmoduleFilePathList) {
        for (let i = 0; i < indexer.HDLparam.length; i++) {
            ...
            if (unitModule.moduleName == module) {
                for (let i = 0; i < unitModule.instmodule.length; i++) {
                    const instanceModule = unitModule.instmodule[i];
    ...
    simulate(indexer) {
        ...
        if (moduleNameList.length >= 1) {
            ...
            this.getInstmoduleFilePathList(indexer, moduleNameList[0], instmoduleFilePathList);
