...
const fsm_base = require('HDLparser/fsm_parser/fsm_base_parser');

class Paser_fsm_verilog extends fsm_base.Parser_fsm_base {
    ...
    async init() {
        ...
        let Lang = await Parser.Language.load(Path.join(Path.dirname(__dirname), Path.sep +
...
module.exports = {
    Paser_fsm_verilog: Paser_fsm_verilog
};
