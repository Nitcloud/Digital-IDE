...
async function launch() {
    ...
    // 本地磁盘挂载
    let aDrives = virtualFileSystem.disk();
    //遍历所有磁盘信息
    for (var i = 0; i < aDrives.length; i++) {
        let diskName = aDrives[i].mounted.toLowerCase();
        console.log(diskName);
        virtualFileSystem.mount(diskName, diskName);
    }
...
// module.FS.mount(
//     module.NODEFS, 
//     { root: 'D:/project/FPGA/FPGA_Design/TCL_project/Test/Extension_test' }, 
//     '/working'
// );
