...
function getFileParam (document, type, offset = 0, parent, HDLparam, HDLSymbol) {
    ...
    // Find blocks
    while (1) {
        let match = vhdl_block.exec(text);
        if (match == null) {
            break;
        }
