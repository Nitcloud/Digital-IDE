...
class synthNetlist {
    ...
    create_viewer(module) {
        ...
        let synthPrjInfo = this.get_prjInfo(module);
    ...
    get_prjInfo(module) {
        ...
        for (let index = 0; index < dependenceFilePathList.length; index++) {
            const dependenceFilePath = dependenceFilePathList[index];
            const dependenceFile = fs.readFileSync(dependenceFilePath, "utf-8");
            synthPrjInfo.push({
                path: dependenceFilePath,
                text: dependenceFile
            })
        }
        return synthPrjInfo;
