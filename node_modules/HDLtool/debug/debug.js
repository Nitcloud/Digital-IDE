...
class toolRegister {
    ...
    runSerialPort(command,) {
        exec(command,function (error, stdout, stderr) {
            ...
            if (SerialPortList[0] == "one") {
                ...
                let command = `python ${opeParam.rootPath}/../resources/tool/.Script/Serial_Port.py runthread ${porteries}`;
    ...
    serialPort() {
        let command = `python ${opeParam.rootPath}/../resources/tool/.Script/Serial_Port.py getCurrentPort`;
