...
const Parser  = require('../tree-sitter/tree-sitter');
const sm_base = require('./sm_base_parser');

class Paser_sm_verilog extends sm_base.Parser_sm_base {
...
module.exports = {
  Paser_sm_verilog: Paser_sm_verilog
};
