...
class iverilogSimulate {
    ...
    constructor(opeParam, outputChannel) {
    ...
    execSimulation(docPath, module, HDLparam) {
        ...
        this.outputChannel.appendLine("//********** iverilog log **********//\n");
        this.outputChannel.appendLine("The DependenceFilePathList (only instance) :\n");
        ...
        this.outputChannel.appendLine(`The commande is : \n\n${command}\n`);
        ...
        child.exec(command, { cwd: currentRunFilePath }, function (error, stdout, stderr) {
            ...
            if (error !== null) {
                ...
                _this.outputChannel.appendLine(`${stderr}`);
                _this.outputChannel.appendLine("//********** iverilog log **********//\n");
                _this.outputChannel.show(true);
                vscode.window.showErrorMessage(stderr);
            } else {
                _this.outputChannel.appendLine("iVerilog simulates successfully!!!\n");
                _this.outputChannel.appendLine("//********** iverilog log **********//\n\n");
