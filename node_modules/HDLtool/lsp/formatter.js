...
class Formatter {
    ...
    provideDocumentFormattingEdits(document, options, token) {
        ...
        this.format(document.languageId, code_to_format).then((formatted_code) => {
            if (formatted_code === null) {
                // vscode.window.showErrorMessage('Select a valid file.!');
                console.log("Error format code.");
                return edits;
            } else {
                const replacement = vscode.TextEdit.replace(selection_to_format, formatted_code);
    ...
    get_vlog_config() {
        let style = vscode.workspace.getConfiguration("HDL.formatter.verilog.default").get("style");
        let args  = vscode.workspace.getConfiguration("HDL.formatter.verilog.default").get("args");
