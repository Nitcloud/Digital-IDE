...
function get_hdl_code(language, reset_signal, reset_state, state_name, clock_name, complete) {
...
exports.get_hdl_code = get_hdl_code;
...
class Vhdl_code {
    ...
    get_vhdl_code(type, reset_signal, reset_state, state_name, clock_name, fsm) {
        let fsm_hdl = "";
        if (type === "one_process") {
...
class Verilog_code {
    ...
    get_verilog_code(type, reset_signal, reset_state, state_name, clock_name, fsm) {
        let fsm_hdl = "";
        if (type === "one_process") {
