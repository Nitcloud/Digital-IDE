...
function processAllHDLFile(src_path, HDLparam) {
    
}
exports.processAllHDLFile = processAllHDLFile
/* Symbol */
/**
...
class index {
    ...
    getFileParam(document, type, offset = 0, parent, HDLparam) {
        if (document.languageId == "systemverilog" || document.languageId == "verilog") {
            return vlogParser.getFileParam(document, type, offset, parent, HDLparam, this.HDLSymbol);
        } else if (document.languageId == "vhdl") {
            return vhdlParser.getFileParam(document, type, offset, parent, HDLparam, this.HDLSymbol);
        }
    }
    /**
        ...
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve) => __awaiter(this, void 0, void 0, function* () {
                resolve(vscode.workspace.openTextDocument(uri).then(doc => {
                    this.getFileParam(doc, null, 0, null, HDLparam);
                }));
            })).then((output) => {
                if (output.length > 0) {
