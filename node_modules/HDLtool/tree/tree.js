    ...
    getChildren(element) {
        ...
        if (element) {
            switch (element.type) {
                ...
                case "sim"  : return parser.utils.getTbTopElement(this.opeParam, this.HDLparam);
...
class FileExplorer {
    constructor(HDLparam, opeParam, _context) {
        ...
        vscode.commands.registerCommand("FILE.expand",   () => this.expand(this._context));
        vscode.commands.registerCommand('FILE.collapse', () => this.collapse(this._context));
    ...
    collapse(context) {
        context.workspaceState.update( 'expanded', false ).then(() => {
            context.workspaceState.update( 'expandedNodes', {} );
        });
    }
    expand(context) {
        context.workspaceState.update( 'expanded', true ).then(() => {
            context.workspaceState.update( 'expandedNodes', {} );
        });
    }
