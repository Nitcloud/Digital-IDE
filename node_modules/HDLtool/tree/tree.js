...
class FileSystemProvider {
    ...
    getTreeItem(element) {
        ...
        if (element.name == "" || element.name == undefined) {
            ...
            else if (element.fsPath.indexOf(this.process.opeParam.workspacePath) == -1) {
                iconPath = "lib";
            ...
            if (fs.existsSync(element.fsPath)) {                
                if (element.fsPath.indexOf(this.process.opeParam.workspacePath) != -1) {                
        ...
        if (iconPath == "top") {
            if (this.process.opeParam.srcTopModule != null && element.mode == "src") {
            ...
            if (this.process.opeParam.simTopModule != null && element.mode == "sim") {
