 ...
 * @param {*} process 
 */
function registerSimServer(context, indexer, process, outputChannel) {
    var simulate = new simulation.iverilogSimulate(process, outputChannel);
 ...
 * @param {*} fileExplorer 
 */
function registerHardServer(context, indexer, process, fileExplorer) {
...
function registerSoftServer(process) {
    ...
    vscode.commands.registerCommand('SOFT.Launch', () => {
        softwareRegister.SDK_Launch(process.opeParam);
    });
    vscode.commands.registerCommand('SOFT.Build', () => {
        softwareRegister.SDK_Build(process.opeParam);
    });
    vscode.commands.registerCommand('SOFT.Download', () => {
        softwareRegister.SDK_Download(process.opeParam);
    });
}
