...
export function getOpeParam(opeParam) {
...
export function generatePropertyPath(workspace_path) {
...
export function generatetbFile(path,root_path) {
...
export function updateFolder(root_path,workspace_path,property_path) {
...
export function updatePrjInfo(root_path, Property_path) {
    if (dirs.ensureExists(Property_path)) {
...
export function getFpgaVersion(Property_path) {
    let prj_param = this.json.pullJsonInfo(Property_path);
    return prj_param.FPGA_VERSION;
}

export function getSocMode(Property_path) {
    let prj_param = this.json.pullJsonInfo(Property_path);
