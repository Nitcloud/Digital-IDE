...
class fpgaRegister {
        ...
        if (this.opeParam.propertyPath != "") {
            ...
            if (!this.currentState) {			
                ...
                if (this.prjParam.FPGA_VERSION == "xilinx") {					
                    this.StartFPGA.sendText(`vivado -mode tcl -s ${this.opeParam.rootPath}/../resources/tool/Xilinx/Script/Vivado/Run.tcl -notrace -nolog -nojournal`);
                }
            ...
            if (prjFileList.length != 0) {
                let command = `vivado -mode gui -s ${this.opeParam.workspacePath}${prjFileList[0]} -notrace -nolog -nojournal`
    ...
    Top(indexer) {
        if (this.currentState == true) {			
			if (this.prjParam.FPGA_VERSION == "xilinx") {	
                xilinx.setTopFile(indexer, (command) => {
    ...
    GUI() {
        if (this.currentState == true){
            ...
            this.currentState = false;
            if (this.prjParam.FPGA_VERSION == "xilinx") {					
                this.StartFPGA.sendText(`vivado -mode gui -s ${this.opeParam.rootPath}/../resources/tool/Xilinx/Script/Vivado/Run.tcl -notrace -nolog -nojournal`);
            }
        }
    }
    Exit() {
