...
class indexer {
    constructor(statusbar, HDLparam, FileList) {
        this.NUM_FILES   = 250;
        this.building    = false;
        this.FileList    = FileList;
        this.statusbar   = statusbar;
        this.Extensions  = ["vhd","vhdl","vho","vht","v","V","vh","vl","sv","SV","svh"];
        this.globPattern = "**/*.{" + this.Extensions.join(",") + "}";
    ...
    getConfig() {
        this.fileExclude        = this.settings.get('HDL.excludeIndexing');
        this.parallelProcessing = this.settings.get('HDL.parallelProcessing');
    }
    findHDLFiles(token) {
        let HDLFileList = __awaiter(this, void 0, void 0, function* () {
            vscode.workspace.findFiles(this.globPattern, this.fileExclude, undefined, token);
        });
        return HDLFileList;
    }
    ...
    */
    build_index() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.fileExclude == "insert globPattern here") {
                this.fileExclude = undefined;
            }
            return yield vscode.window.withProgress({
                ...
                this.symbols = new Map();
                let uris = this.findHDLFiles(token);
                // let uris = yield Promise.resolve(this.findHDLFiles(token));
