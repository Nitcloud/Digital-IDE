...
class hardwareRegister {
    ...
    getPrjStruct() {
        if (filesys.files.isHasValue(opeParam.prjInfo, "PRJ_STRUCTURE", "customer")) {
            // 视之为用户自定义文件结构
            this.prjStruct.prjPath = `${this.opeParam.workspacePath}/prj`;
            this.prjStruct.HardwareSrc  = `${this.opeParam.workspacePath}/user/src`;
            this.prjStruct.HardwareSim  = `${this.opeParam.workspacePath}/user/data`;
            this.prjStruct.HardwareData = `${this.opeParam.workspacePath}/user/data`;
        } else {
            // 视之为标准文件结构
            let prjFilePath;
            let prjFiles = [];
