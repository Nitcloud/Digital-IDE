...
function registerSimServer(indexer, opeParam){
    ...
    vscode.commands.registerCommand('TOOL.simulate', () => {
        simulate.simulate(indexer.HDLparam);
    });
    ...
    vscode.commands.registerCommand('TOOL.testbench', () => {
        simTestbench.genInstancetoTbFile(indexer, opeParam.tbFilePath);
    });
    vscode.commands.registerCommand('TOOL.Generate_tb', () => {
        simTestbench.generatetbFile(opeParam);
    });
...
function registerBuildServer(context, indexer, opeParam){
    ...
    vscode.commands.registerCommand('FPGA.srcTop', () => {
        xilinxBuild.setSrcTop(indexer.HDLparam);
    });
    vscode.commands.registerCommand('FPGA.simTop', () => {
        xilinxBuild.setSimTop(indexer.HDLparam);
    });
