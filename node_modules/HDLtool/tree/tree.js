...
class FileSystemProvider {
    ...
    getChildren(element) {
        ...
        if (element) {
            switch (element.type) {
                case "src"  : return parser.simParser.getSrcTopElement(this.opeParam, this.HDLparam);
                // case "Data"      : return this.getDataTopElement();
                case "sim"  : return parser.simParser.getTbTopElement(this.opeParam, this.HDLparam);
