...
class synthNetlist {
    ...
    async get_prjInfo(module) {
        ...
        synth.loadFile(dependenceFilePathList.inst, this.opeParam.workspacePath);
        synth.loadFile(dependenceFilePathList.include, this.opeParam.workspacePath);
        synth.loadFile([module.path], this.opeParam.workspacePath);
    }
